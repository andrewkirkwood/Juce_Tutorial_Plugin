...
//==============================================================================
const String TutorialAudioProcessor::getName() const
{
...
const String TutorialAudioProcessor::getProgramName (int index)
{
    return {};
}

void TutorialAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void TutorialAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* TutorialAudioProcessor::createEditor()
{
    return new TutorialAudioProcessorEditor (*this);
}

//==============================================================================
void TutorialAudioProcessor::getStateInformation (MemoryBlock& destData)
{
